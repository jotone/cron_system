...
@section('scripts')
	<script type="text/javascript" src="{{ URL::asset('js/admin/footer_menu.js') }}"></script>
@stop
@section('content')
<div class="main-block">
	<div class="center-wrap col_1">
		...
		<div class="button-wrap">
			<a class="control-button" href="{{ route('admin-footer-menu-add') }}">Добавить</a>
		</div>
					...
					<li data-id="{{ $item->id }}">
						<div class="category-wrap">
							...
							<div class="category-controls">
								...
								<a class="button edit" href="{{ route('admin-footer-menu-edit', $item->id) }}" title="Редактировать"><img src="{{ URL::asset('images/edit.png') }}" alt="Редактировать"></a>
