		...
		<div class="work-place-wrap">
			...
			<div>
				<fieldset>
					...
					<div class="row-wrap">
						<label class="fieldset-label-wrap">
							<input name="is_outer" type="checkbox" class="chbox-input" @if( (isset($content)) && ($content->is_outer == 1)) checked="checked" @endif>
							<span>Является ссылкой на внешний ресурс</span>
						</label>
					</div>
				</fieldset>
			</div>
